#create a Abstract class with variables and argurement
import random
class Coin:
    #**kwargs is used to pack the argument
    def __init__(self,rare = False,clean = True, **kwargs ):

        #using the code in below two lines we can assign the dictanory value to self.
    ...
    #__self__ keyword tells about the object
    def __str__(self):
...
#using Inheritence Coin class to make Pound
...
class One_Pence(Coin):
    def __init__(self):
        ...
        #To access the Parent Class we can use the super() keyword
         #** symbol can be used to unpack the dictonary
        super().__init__(**data)
